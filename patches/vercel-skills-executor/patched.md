...
<!-- VERCEL_SKILLS_ROUTING_EXECUTOR -->
<Vercel_Skill_Routing>
  On genuine domain match, BEFORE writing code, explicitly invoke the matching absorbed skill and
  follow its checklist (these are lazy owned skills, not always-on rules):
  - React / Next.js component, hook, data-fetch, bundle, or performance work ->
    `Skill("vercel-react-best-practices")`; for component composition also
    `Skill("vercel-composition-patterns")`; for route/page/shared-element transitions
    `Skill("vercel-react-view-transitions")`.
  - React Native work -> `Skill("vercel-react-native-skills")`.
  Invoke only on real domain match; skip entirely for backend / CLI / unrelated tasks.
</Vercel_Skill_Routing>
<!-- /VERCEL_SKILLS_ROUTING_EXECUTOR -->
